...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <button id="emp_add_modal_btn" class="btn btn-primary" data-toggle="modal" data-target="#empAddModel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button id="empAddModel_close_btn" type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade" id="empUpdateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button id="empUpdateModel_close_btn" type="button" class="close" data-dismiss="modal"
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control" name="email" id="empEmail_update_input"
                                   placeholder="email@163.com">
                            <span id="empUpdateModel_isError_email" class="help-block"
            ...
            <div class="modal-footer">
                <button id="empUpdateForm_close_btn" type="button" class="btn btn-default" data-dismiss="modal">关闭
                </button>
